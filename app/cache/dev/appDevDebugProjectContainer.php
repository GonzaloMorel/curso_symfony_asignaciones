...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        $f->addEventSubscriber(new \Vich\UploaderBundle\EventListener\Doctrine\CleanListener('usuario_file', $e, $a, $b));
        $f->addEventSubscriber(new \Vich\UploaderBundle\EventListener\Doctrine\RemoveListener('usuario_file', $e, $a, $b));
        $f->addEventSubscriber(new \Vich\UploaderBundle\EventListener\Doctrine\UploadListener('usuario_file', $e, $a, $b));

        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_pgsql', 'host' => '127.0.0.1', 'port' => 5432, 'dbname' => 'Usuarios', 'user' => 'psqluser', 'password' => 'postgres', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $d, $f, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => ($this->targetDirs[3].'/src/UsuarioBundle/Entity'))), 'UsuarioBundle\\Entity');

        $b = new \Doctrine\ORM\Configuration();
        $b->setEntityNamespaces(array('UsuarioBundle' => 'UsuarioBundle\\Entity'));
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('faeb9f758219ac6e6b9946347a6fcd5b');
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('56dcb8570e4d87.57641123')), true);
    ...
    {
        return $this->services['vich_uploader.property_mapping_factory'] = new \Vich\UploaderBundle\Mapping\PropertyMappingFactory($this, $this->get('vich_uploader.metadata_reader'), array('usuario_file' => array('uri_prefix' => '/usuario/files', 'upload_destination' => ($this->targetDirs[2].'/../web/files'), 'namer' => NULL, 'directory_namer' => NULL, 'delete_on_remove' => true, 'delete_on_update' => true, 'inject_on_load' => false, 'db_driver' => 'orm')), '_name');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'secret' => 'faeb9f758219ac6e6b9946347a6fcd5b',
            'locale' => 'en',
            ...
            'kernel.secret' => 'faeb9f758219ac6e6b9946347a6fcd5b',
            ...
            'vich_uploader.mappings' => array(
                'usuario_file' => array(
                    'uri_prefix' => '/usuario/files',
                    'upload_destination' => ($this->targetDirs[2].'/../web/files'),
                    'namer' => NULL,
